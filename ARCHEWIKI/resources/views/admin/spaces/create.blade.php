...
<div class="max-w-3xl mx-auto mt-10 bg-white p-8 shadow-lg rounded-xl">
    <h2 class="text-2xl font-bold mb-6 text-indigo-700">Cadastrar Espaço</h2>

    <form action="{{ route('admin.spaces.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="mb-4">
            <label class="block text-gray-700 mb-2">Nome do Espaço</label>
        ...
        <div class="mb-4">
            ...
            <textarea name="description" rows="4" class="w-full border border-gray-300 rounded-lg px-3 py-2" required></textarea>
        </div>
